				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<input type="button" value="Click Here" id="nirf">
							<script>
							$(document).ready(function() {
								$("#nirf").click(function() {
									...
									for(var i=1;i<=nirfValue;i++){
										$("#nirfTable").empty();
									add1+="<tr>"
									add1+="<td><input type='text' placeholder=Title"+i+"></td>";
									add1+="<td><input type='text' placeholder=Journal"+i+"></td>";
									add1+="<td><input type='text' placeholder=Publication"+i+"_MM/YYYY></td>";
									add1+="<td><input type='text' placeholder=Publictation"+i+"_1st_pg></td>";
						...
						<tr>
							...
							<td><input type="number" id="indexedPapers"
						     ...
						     <input type="button" value="Click Here" id="indexp">
							<script>
							$(document).ready(function() {
								$("#indexp").click(function() {
									...
									add2+="<td><input type='text' placeholder=Publication"+i+"_MM/YYYY></td>";
						...
						<tr>
							...
							<td><input type="number" id="journalPublication"
								...
								<input type="button" value="Click Here" id="jpublicatn">
							<script>
							$(document).ready(function() {
								$("#jpublicatn").click(function() {
									...
									add3+="<td><input type='text' placeholder=Publication"+i+"_MM/YYYY></td>";
						...
						<tr>
							...
							<input type="button" value="Submit" id="bookdet"></td>
							</tr>
							...
							$(document).ready(function() {
								$("#bookdet").click(function() {
									...
									add4+="<td><input type='text' placeholder=Publication"+i+"_MM/YYYY></td>";
						...
						<tr>
							...
							$(document).ready(function() {
								$("#disClosure").click(function() {
									...
									var add5="<tr>";
									add5+="<td><b>FilingNumber/FileNumber Date</b></td>";
									...
									add5+="<tr>"
									add5+="<td><input type='text' placeholder=FilingNumber/FileNumber"+i+"_MM/YYYY></td>";
						...
						<tr>
							...
							$(document).ready(function() {
								$("#patentGranted").click(function() {
									...
									add7+="<tr>"
									add7+="<td><input type='text' placeholder=Patent_Number"+i+"></td>";
									add7+="<td><input type='text' placeholder=Year_of_Grant"+i+"_MM/YYYY></td>";
						...
						<tr>
							...
							$(document).ready(function() {
								$("#researchGuidePhd").click(function() {
									...
									add10+="<td><input type='text' placeholder=DD-MM-YYYY></td>";
						...
						<tr><td style="width: 50%;"><label for="fundedProjects5">Only the first page of the sanction letter</label></td><td style="width:50%;"><input type="text" id="fundedProjects5" /></td></tr>
							</table>
							</td>
						...
						<tr> <td style="width: 50%;">   <label for="consultingProjects5">Only the first page of the sanction letter</label></td><td style="width:50%;"><input type="text" id="consultingProjects5" /></td></tr>	
							</table>	
							</td>
						...
						<tr> <td> <label>Only the first page of brochure of the event</label></td></tr>
							</table>
							</td>
						...
						<tr>
							...
							$(document).ready(function() {
								$("#invitedTO").click(function() {
									...
									add15+="<td><input type='text' placeholder=DD/MM/YYYY></td>";
									add15+="</tr>";	
									$("#invitedTOTable").append(add15); }
							}		
							);
							...
							$(document).ready(function() {
								$("#eventOutside").click(function() {
									...
									for(var i=1;i<=eventOutsideValue;i++){
										$("#eventOutsideTable").empty();
									add16+="<tr>"
									add16+="<td><input type='text' placeholder=EventName></td>";
									add16+="<td><input type='text' placeholder=Venue"+i+"></td>";
									add16+="<td><input type='text' placeholder=DD/MM/YYYY></td>";
									add16+="</tr>";	
									$("#eventOutsideTable").append(add16); }
							}		
							);
						...
						<tr>
							...
							$(document).ready(function() {
								$("#invitedTI").click(function() {
									...
									add17+="<td><input type='text' placeholder=DD/MM/YYYY></td>";
									add17+="</tr>";	
									$("#invitedTITable").append(add17); }
							}		
							);
						...
						<tr>
							...
							$(document).ready(function() {
								$("#industryRelation").click(function() {
									...
									add18+="<td><input type='text' placeholder=DD/MM/YYYY></td>";
									add18+="</tr>";	
									$("#industryRelationTable").append(add18); }
							}		
							);
						...
						<tr> <td style="width: 50%;">  <label for="detailsOfResponsibilities">Details_of_responsibilities</label> </td> <td style="width: 50%;">  <input type="text" id="responsibilitiesDetails" name="responsibilitiesDetails" min="0" value="0" /> </td> </tr>	
						<tr> <td><label for="letterfromHod">Letter from HoD designating the same</label> </td></tr>	
							</table>
							</td>
							...
							$(document).ready(function() {
								$("#othService").click(function() {
									...
									for(var i=1;i<=othServiceValue;i++){
										$("#othServiceTable").empty();
									add20+="<tr>"
									add20+="<td><input type='text' placeholder=ActivityDetails></td>";
									add20+="</tr>";	
										$("#othServiceTable").append(add20); }
							}		
							);
							...
							$(document).ready(function() {
								$("#awardsHonour").click(function() {
									...
									for(var i=1;i<=awardsHonourValue;i++){
										$("#awardsHonourTable").empty();
									add21+="<tr>"
									add21+="<td><input type='text' placeholder=AwardName></td>";
									add21+="<td><input type='text' placeholder=OrganisationName></td>";
									add21+="<td><input type='text' placeholder=DateOfEvent></td>";
									add21+="</tr>";	
										$("#awardsHonourTable").append(add21); }
							}		
							);
